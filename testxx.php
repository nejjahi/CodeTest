...
.select2-container--default .select2-results__options {
  ...
  overflow-y: auto !important;
				...
				<div class="container">
					<div class="row fullscreen d-flex align-items-center justify-content-center">
						<div class="banner-content col-lg-12">
							<h1 class="text-white">
								<span><?php echo $jobsCount[0]; ?></span> Jobs posted last week				
							</h1>	
									...
									<div class="col-lg-3 form-cols">
										<div class="default-select" id="default-selects">
											<select class="my-select">
                                                <option value="0">Select a categoy</option>
                                                  <?php 
                                                    while($data=$selectSubCategories->fetch())
                                                    {
      ...
      <?php 
        while($data=$selectProvinces->fetch())
        {
          echo "<option value='0' disabled>************* ".$data['name']." *************</option>";
          $selectCities->execute(array($data['id']));
            while($data2=$selectCities->fetch())
              echo "<option value='".$data2['id']."'> --- ".$data2['city']."</option>";
        }
      ?>
                                            </select>
										</div>										
...
<!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            ...
            <script src="js/home_titles.js"></script>	
